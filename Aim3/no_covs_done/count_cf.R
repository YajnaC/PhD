...
# results <- get(load("~/Aim3/no_covs/results_varen_medf_count.rda"))
results <- get(load("~/Aim3/no_covs/results_cNRT_medf_count.rda"))
# 
# results <- get(load("~/Aim3/no_covs/results_varen_medp_count.rda"))
# results <- get(load("~/Aim3/no_covs/results_cNRT_medp_count.rda"))
