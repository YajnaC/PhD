...
for(i in 1:nrow(dat4)){
  ...
  if(dat4$time_pt[i] == 1){
    ...
    dat4$prob_L[i] <- exp(-0.2*dat4$x1[i] - 0.1*dat4$treat[i] + 0.25*dat4$L[i-1])/(1 + exp(-0.2*dat4$x1[i] - 0.1*dat4$treat[i] + 0.25*dat4$L[i-1]))
  }
  dat4$L[i] <- rbinom(1,1,dat4$prob_L[i])
  
  ## Create mediator data
  if(dat4$time_pt[i] == 1){
    dat4$num[i] <- exp(dat4$alpha0[i] + dat4$alpha1[i]*dat4$treat[i] - 2.2*dat4$L[i] + 0.05*dat4$x1[i])
  }else if(dat4$time_pt[i] > 1){
    dat4$num[i] <- exp(dat4$alpha0[i] + dat4$alpha1[i]*dat4$treat[i] + 1.25*dat4$M[i-1] - 2.2*dat4$L[i] + 0.05*dat4$x1[i])
  }
  dat4$prob_M[i] <- dat4$num[i]/(1 + dat4$num[i])
...
for(i in 1:nrow(dat4)){
  ...
  if(dat4$time_pt[i] == 1){
    dat4$num_c[i] <- exp(dat4$beta0[i] + dat4$gamma_A[i]*dat4$treat[i] + dat4$beta1_c[i]*dat4$M[i] + 0.36*dat4$L[i] - 0.02*dat4$x1[i])
    dat4$num_r[i] <- (dat4$beta0[i]-2) + dat4$gamma_A[i]*dat4$treat[i] + dat4$beta1_r[i]*dat4$M[i] + 0.36*dat4$L[i] - 0.02*dat4$x1[i]
  }else if(dat4$time_pt[i] > 1){
    dat4$num_c[i] <- exp(dat4$beta0[i] + dat4$gamma_A[i]*dat4$treat[i] + dat4$beta1_c[i]*dat4$M[i] + 0.36*dat4$L[i] - 0.02*dat4$x1[i] + 0.9*dat4$Yc[i-1])
  ...
  if(dat4$time_pt[i] == 1){
    dat4$num_pr1[i] <- exp(dat4$beta0[i] - 0.2*dat4$treat[i] - 0.9*dat4$M[i] + 0.5*dat4$L[i] - 0.02*dat4$x1[i])
    ...
    dat4$num_pr11[i] <- exp(dat4$beta0[i] - 0.2*dat4$treat[i] - 0.9*dat4$M[i] + 0.5*dat4$L[i] - 0.02*dat4$x1[i])
    dat4$mu.count.zi1[i] <- exp((dat4$beta0[i] + 0.5) + dat4$gamma_A[i]*dat4$treat[i] + dat4$beta1_c[i]*dat4$M[i] + 0.36*dat4$L[i] - 0.02*dat4$x1[i])
    
  }else if(dat4$time_pt[i] > 1){
    dat4$num_pr1[i] <- exp(dat4$beta0[i] - 0.2*dat4$treat[i] - 0.9*dat4$M[i] + 0.5*dat4$L[i] - 0.02*dat4$x1[i] + 0.15*dat4$Cigc[i-1])
    dat4$mu.count.zi[i] <- exp((dat4$beta0[i] + 0.5) + dat4$gamma_A[i]*dat4$treat[i] + dat4$beta1_c[i]*dat4$M[i] + 0.36*dat4$L[i] - 0.02*dat4$x1[i] + 0.15*dat4$Cigc[i-1])
    ...
    dat4$num_pr11[i] <- exp(dat4$beta0[i] - 0.2*dat4$treat[i] - 0.9*dat4$M[i] + 0.5*dat4$L[i] - 0.02*dat4$x1[i] + 0.15*dat4$Cigc1[i-1])
    dat4$mu.count.zi1[i] <- exp((dat4$beta0[i] + 0.5) + dat4$gamma_A[i]*dat4$treat[i] + dat4$beta1_c[i]*dat4$M[i] + 0.36*dat4$L[i] - 0.02*dat4$x1[i] + 0.05*dat4$Cigc1[i-1])
    
  }
  dat4$prob0_zi1[i] <- 1-(dat4$num_pr11[i]/(1 + dat4$num_pr11[i]))
  dat4$prob0_zi[i] <- 1-(dat4$num_pr1[i]/(1 + dat4$num_pr1[i]))
  
  dat4$Cigc1[i] <- rzipois(1, dat4$mu.count.zi1[i], pstr0 = dat4$prob0_zi1[i]) ## zero-inflated count ##
...
aim2_dat <- dat4
save(aim2_dat, file = "aim2_dat.rda")
