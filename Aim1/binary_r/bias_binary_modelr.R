...
# results <- get(load("~/Aim1/binary_r/results_binary_200_modelr.rda"))
results <- get(load("~/Aim1/binary_r/results_binary_500_modelr.rda"))
# results <- get(load("~/Aim1/binary_r/results_binary_700_modelr.rda"))
...
bias_tv_made <- bias_tv_made[-c(1438, 406, 381, 1608, 1793, 1965, 1943,
                                1169, 649, 1225, 563, 526, 1884, 1976,
                                882, 206, 1736, 1282, 77, 708, 1319,
                                548, 1224, 944, 1016, 286, 1100, 1008,
                                173, 1348, 291, 558, 710, 421, 602,
                                16, 594, 1279, 1458, 1741, 888, 1001,
                                485, 1301, 816),]
bias_tv_made <- bias_tv_made[-c(1625),]
...
bias_tv_wase <- bias_tv_wase[-c(1438, 406, 381, 1608, 1793, 1965, 1943,
                                 1169, 649, 1225, 563, 526, 1884, 1976,
                                 882, 206, 1736, 1282, 77, 708, 1319,
                                 548, 1224, 944, 1016, 286, 1100, 1008,
                                 173, 1348, 291, 558, 710, 421, 602,
...
bias_tv_wase <- bias_tv_wase[-c(1625),]
...
# bias <- bias[-c(1438, 406, 381, 1608, 1793, 1965, 1943,
#                  1169, 649, 1225, 563, 526, 1884, 1976,
#                  882, 206, 1736, 1282, 77, 708, 1319,
#                  548, 1224, 944, 1016, 286, 1100, 1008,
#                  173, 1348, 291, 558, 710, 421, 602,
