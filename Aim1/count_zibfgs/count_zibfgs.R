### Models for count outcome - zero-inflated with log link for zero component using the BFGS method###
...
save(results_continuous, file = paste("results_count_zibfgs_700.rda", sep = ""))
